...
class NetEqNetworkStatistics : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:webrtc.neteq_unittest.NetEqNetworkStatistics) */ {
 public:
  ...
  inline NetEqNetworkStatistics* New() const PROTOBUF_FINAL { return New(NULL); }

  NetEqNetworkStatistics* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
...
class RtcpStatistics : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:webrtc.neteq_unittest.RtcpStatistics) */ {
 public:
  ...
  inline RtcpStatistics* New() const PROTOBUF_FINAL { return New(NULL); }

  RtcpStatistics* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
